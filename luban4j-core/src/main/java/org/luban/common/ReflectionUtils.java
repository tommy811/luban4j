...
public abstract class ReflectionUtils {
	...
	public static void setValue(String name, Object value, Object target) {
		 setField(findField(target.getClass(), name),target,value);
	}

	public static void setFinalVal(String name, Object value, Object target)  {
		try {
			setFinalVal(target, findField(target.getClass(), name), value);
		} catch (NoSuchFieldException | IllegalAccessException e) {
			throw new RuntimeException(e);
		}
	}

	public static void setFinalVal(Object source, Field field, Object newValue) throws NoSuchFieldException, IllegalAccessException {
		field.setAccessible(true);
		// 修改常量修饰
